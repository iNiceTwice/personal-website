            ...
            <div className="flex flex-row-reverse justify-center lg:justify-start items-center playfair text-4xl lg:text-7xl">
                <div>
                    ...
                    <motion.div initial={{opacity:0, x:-50}} transition={{type:"tween",delay:0.8, duration:0.5}} animate={{opacity:1,x:0}} className="flex gap-4 mt-6 items-center">
                        ...
                        <a href="https://drive.google.com/file/d/1raa4tqOCRZ5CbzXUQLBkHO6JNpKjyLmI/view?usp=share_link" target="_blank" rel="noreferrer" className="text-base text-white font-sans flex justify-center items-center p-3 bg-rose-800 hover:bg-rose-800/90 transition-colors">
                            My resume
